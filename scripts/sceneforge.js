...
function compileInkarnatePrompt(prompt, options = {}) {
  ...
  const spatialIntegrityLines = buildingViewMode === "roofs-no-interior"
    ? [
      "ROOF FOOTPRINTS, STREETS, COURTYARDS, AND GATES MUST CONNECT IN A LOGICAL NAVIGABLE LAYOUT",
      "NO CUTAWAYS, NO PARTIAL INTERIORS, NO EXPOSED SIDE WALLS, NO IMPOSSIBLE BUILDING OVERLAPS"
    ]
    : [
      "EVERY MAJOR ROOM MUST HAVE A PLAUSIBLE ACCESS ROUTE THROUGH DOORS, CORRIDORS, OR OPENINGS",
  ...
  const lines = [
    ...
    "HARD REQUIREMENTS: DO NOT VIOLATE PLAN-VIEW OR SPATIAL-LOGIC RULES",
    ...
    "NO CHARACTERS",
    "NO TEXT ANYWHERE",
    "NO LETTERS OR NUMBERS IN ANY ROOM OR AREA",
    "NO ROOM LABELS, NO TILE LABELS, NO LEGENDS, NO TITLES, NO CAPTIONS",
    "NO GLYPHS, NO RUNES, NO SIGNAGE, NO CALLOUTS, NO ANNOTATIONS",
    "NO WATERMARKS, NO LOGOS, NO UI ELEMENTS, NO BORDER TEXT",
